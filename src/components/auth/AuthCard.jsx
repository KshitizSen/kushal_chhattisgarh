    ...
    >
      ...
      {(title || subtitle) && (
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            {title && (
              <h2 className="text-[1.65rem] font-heading font-bold text-white tracking-tight leading-tight">
                {title}
              </h2>
            )}
            {subtitle && (
              <p className="text-sm text-white/40 mt-2.5 leading-relaxed font-medium">
                {subtitle}
              </p>
            )}
          </div>
