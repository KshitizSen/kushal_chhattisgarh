...
const TrackingTimeline = ({ report }) => {
  ...
  const steps = [
    { stepLabel: '1A', label: 'Principal / HM (Head Master)', status: report.hm_approval_status, icon: UserCheck },
...
const AttendanceTracking = () => {
  ...
  const summaryCards = useMemo(() => [
    ...
    { label: 'HM (Head Master) Approved', value: summary.hm_approved || 0, icon: UserCheck, color: 'text-green-600', bg: 'bg-green-50 dark:bg-green-900/20' },
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Track monthly VT approval from Principal/HM (Head Master), VTP, and DEO.
          </p>
        </div>
            ...
            <table className="w-full min-w-[980px]">
              <thead className="border-b border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-950">
                <tr>
                  ...
                  <th className="px-5 py-4 text-left text-xs font-semibold uppercase tracking-[0.16em] text-gray-500 dark:text-gray-400">Principal / HM (Head Master)</th>
