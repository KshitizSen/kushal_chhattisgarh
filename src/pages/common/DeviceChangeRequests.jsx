      ...
      <div className="overflow-x-auto rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
        <table className="min-w-full text-left text-sm"><thead className="bg-gray-50 text-gray-600 dark:bg-gray-800 dark:text-gray-300"><tr>{['VT', 'School / VTP', 'Reason', 'HM Status', 'VTP Status', 'Action'].map((h) => <th key={h} className="px-4 py-3 font-medium">{h}</th>)}</tr></thead>
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            {!loading && requests.length === 0 && <tr><td colSpan="6" className="px-4 py-10 text-center text-gray-500">No device change requests found.</td></tr>}
            {loading && <tr><td colSpan="6" className="px-4 py-10 text-center text-gray-500">Loading requests...</td></tr>}
          </tbody></table>
      </div>
      <Modal
